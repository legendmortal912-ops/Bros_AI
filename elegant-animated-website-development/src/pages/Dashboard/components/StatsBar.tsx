      ...
      {items.map(({ label, value, icon: Icon, color, glow }) => (
        <div
          ...
          onMouseEnter={e => {
            ...
            (e.currentTarget as HTMLDivElement).style.background = `linear-gradient(145deg, ${glow}, rgba(255,255,255,0.02))`;
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLDivElement).style.border = '1px solid rgba(255,255,255,0.07)';
            (e.currentTarget as HTMLDivElement).style.background = 'linear-gradient(145deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.02) 100%)';
          }}
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.45)', fontWeight: 500, letterSpacing: '0.2px' }}>
              {label}
            </span>
          </div>
          <div
