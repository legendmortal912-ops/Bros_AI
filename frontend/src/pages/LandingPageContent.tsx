    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link to="/auth" className="text-sm text-violet-300 hover:text-white transition-colors px-4 py-2 font-medium">
            Sign in
          </Link>
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
            <Link
              to="/auth"
              className="inline-block text-sm font-semibold bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white px-5 py-2.5 rounded-xl transition-all duration-200 shadow-lg shadow-violet-900/40"
            >
              Get Early Access
            </Link>
          </motion.div>
        ...
        {open && (
          ...
          >
            ...
            <Link
              to="/auth"
              onClick={() => setOpen(false)}
              className="block w-full mt-2 text-center bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white text-sm font-semibold py-3 rounded-xl"
            >
              Get Early Access
            </Link>
          </motion.div>
    ...
    <footer className="bg-[#04020a] border-t border-violet-900/30 py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-violet-900/30 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-violet-500/40 text-xs">© 2026 Bros AI. All rights reserved.</p>
